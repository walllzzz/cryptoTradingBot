...
public class CryptoTradingBotApp {

    private static final Logger log = LoggerFactory.getLogger(CryptoTradingBotApp.class);

    private final Environment env;

    public CryptoTradingBotApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes cryptoTradingBot.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(CryptoTradingBotApp.class);
